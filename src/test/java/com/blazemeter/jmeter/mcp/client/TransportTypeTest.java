...
class TransportTypeTest {
  ...
  void shouldParseTransportWhenFromStringUsesHyphensOrUnderscores() {
    ...
    assertEquals(TransportType.STREAMABLE_HTTP, TransportType.fromString("streamable-http"));
  }

  @Test
  void shouldRejectUnknownTransportWhenFromString() {
    assertThrows(IllegalArgumentException.class, () -> TransportType.fromString("websocket"));
  }
}
