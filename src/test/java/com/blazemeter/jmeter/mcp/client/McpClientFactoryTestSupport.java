...
/**
 * Invokes package-private {@link McpClientFactory} transport wiring without opening a live MCP
 * session.
 */
final class McpClientFactoryTestSupport {
  ...
  static McpClientTransport buildTransport(McpClientSettings settings) {
    try {
      Method method =
          McpClientFactory.class.getDeclaredMethod("buildTransport", McpClientSettings.class);
