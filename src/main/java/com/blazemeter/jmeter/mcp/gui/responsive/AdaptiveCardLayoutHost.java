...
/**
 * {@link java.awt.CardLayout} reserves vertical space for the tallest card. This host
 * ties the card panel height to the <em>visible</em> card and adds vertical glue so
 * extra space sits below the form (same idea as HTTP/2 {@code AdaptiveTabbedPaneHeightHost}).
 */
