...
public final class EnvVarsField {
  ...
  /**
   * JMeter {@link org.apache.jmeter.gui.AbstractJMeterGuiComponent#makeScrollPane} sets preferred
   * size to the text area minimum (often a single line). Apply a row-based height after {@code
   * makeScrollPane(area)}.
   */
