...
/**
 * Caps column-based preferred widths and clears rigid horizontal minimum sizes so plugin forms
 * reflow when JMeter's property panel is narrowed.
 */
public final class ResponsiveSizing {
  ...
  /**
   * Visits {@code root} and descendants. Children are processed first so parent {@link FlowLayout}
   * sizes reflect updated text fields.
   */
