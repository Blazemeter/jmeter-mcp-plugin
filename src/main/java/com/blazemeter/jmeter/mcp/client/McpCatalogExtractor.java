...
public final class McpCatalogExtractor {
  ...
  public static List<String> resourceUris(McpSyncClient client) {
    ...
    String cursor = null;
    do {
      McpSchema.ListResourcesResult result =
          cursor == null ? client.listResources() : client.listResources(cursor);
  ...
  public static List<String> promptNames(McpSyncClient client) {
    ...
    String cursor = null;
    do {
      McpSchema.ListPromptsResult result =
          cursor == null ? client.listPrompts() : client.listPrompts(cursor);
